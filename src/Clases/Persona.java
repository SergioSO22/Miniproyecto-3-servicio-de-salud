...
public class Persona {
    ...
    /**
     * Crea una persona y posiciona los atributos nombre y dni.
     * @param nombre es el valor asignado al atributo nombre
     * @param dni es el valor asignado al atributo dni
     */
