...
import Clases.GestionDeAfiliados;
import Clases.GestionDeConsultorios;
import Clases.GestionDeMedicos;
import Clases.GestionDeCitas;
import Clases.GestionDeServiciosMedicos;
...
public class VentanaGestion extends javax.swing.JFrame {
    ...
    public VentanaGestion() {
        initComponents();
        gestionAfiliados = new GestionDeAfiliados();
        gestionAfiliados.restaurarDatos();
        gestionMedicos = new GestionDeMedicos();
        gestionMedicos.restaurarDatos();
        gestionConsultorios = new GestionDeConsultorios();
        gestionConsultorios.restaurarDatos();
        gestionServicios = new GestionDeServiciosMedicos();
        gestionServicios.restaurarDatos();
        gestionCitas = new GestionDeCitas();
    ...
    private GestionDeServiciosMedicos gestionServicios;
    private GestionDeConsultorios gestionConsultorios;
    private GestionDeMedicos gestionMedicos;
    private GestionDeAfiliados gestionAfiliados;
    private GestionDeCitas gestionCitas;
    private int opcion1;
    private int opcion2;
